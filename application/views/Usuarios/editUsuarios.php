...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= site_url("Usuarios/Consultar") ?>">Usuarios</a></li>
        <li class="breadcrumb-item active" aria-current="page"><?= $editar ? "Usuario " . $Usuario["nombre"] : "Nuevo Usuario" ?></li>
    </ol>
</nav>
            ...
            <div class="col-lg-12">
                <div class="p-5">
                    <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4"><?= $editar ? "Modificar Usuario " : "Nuevo Usuario" ?></h1>
                    </div>
                    ...
                    <form id="frmame" class="user">
                                ...
                                <div class="row col-12">
                                    <div class="col col-12 col-sm-6">
                                        <div class="mb-3 mb-sm-0">
                                            ...
                                            <input class="form-control mb-2" maxlength="9" name="telefono" id="telefono" placeholder="" value="<?= isset($Usuario["telefono"])  ? $Usuario["telefono"] : "" ?>">
                                        </div>
                                        <div class="mb-3 mb-sm-0">
                                                ...
                                                if($editar){
                                                    switch ($Usuario["estado"]) {
                                                        ...
                                                        case 'BLOQUEADO':?>
                                                            <option>ACTIVO</option>
                                                            <option>INACTIVO</option>
                                                            <option selected>BLOQUEADO</option> <?php
                                                            break;
                        ...
                        <div class="col text-center">
                            ...
                            <a class='col-lg-1 btn btn-danger'  href='<?php echo site_url("Usuarios/Consultar") ?>' >Salir</a>
    ...
    $(function() {  
        ...
        $("#idDepartamento").on("change", function() {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "<?php echo site_url("Usuarios/Municipios") ?>",
                data: {
